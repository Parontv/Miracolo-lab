...
function panelSettings() {
  ...
  <div class="panel-body">
    ...
    <div class="panel-section">
      ...
      <div class="p-card">
        <div class="stat-row"><span class="stat-key">Versione</span><span class="stat-val">1.0</span></div>
        ...
        <div class="stat-row"><span class="stat-key">AI</span><span class="stat-val">Gemini 2.5 Flash</span></div>
      </div>
    </div>
  </div>`;
}
const FEEDS_COUNT = 45;
