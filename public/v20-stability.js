...
(()=>{'use strict';
  ...
  if(typeof original==='function'&&!original.__v20Stable){
    const wrapped=function(id){ if(!PANELS.includes(id))return original(id); markActive(id); return original(id); };
    wrapped.__v20Stable=true; wrapped.__v20Original=original; window.setPanel=wrapped;
  }
