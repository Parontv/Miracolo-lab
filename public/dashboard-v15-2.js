...
async function runDashboardScan(){
  ...
  if(window.__mlScanInProgress)return;
  ...
  try{
    ...
    if(typeof S!=='undefined'){S.signals=d.top_signals||[];S.sources=d.sources||[];S.summary=d.summary||{};if(d.blackSwan)S.blackSwan=d.blackSwan}
    ...
    if(typeof renderSources==='function')renderSources(d.sources||[]);if(typeof renderFeed==='function')renderFeed();if(typeof setStatus==='function')setStatus('ONLINE','ok');
