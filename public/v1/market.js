...
function renderCharts(candles){
 ...
 state.chart=LC.createChart(mainEl,baseOptions(mainEl.clientWidth||600,mainEl.clientHeight||390));
 ...
 state.volume=LC.createChart(volEl,baseOptions(volEl.clientWidth||600,volEl.clientHeight||105));
 ...
 state.rsi=LC.createChart(rsiEl,baseOptions(rsiEl.clientWidth||600,rsiEl.clientHeight||130));
