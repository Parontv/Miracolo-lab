...
old="function sentiment(i){const t=(i.title+' '+i.description).toLowerCase();let s=0;if(/bullish|rally|surge|breakout|beat|inflow|upgrade|record high|easing|rate cut|strong growth/.test(t))s++;if(/bearish|crash|dump|selloff|plunge|outflow|downgrade|recession|liquidat|hawkish|rate hike|panic|default/.test(t))s--;return s}"
