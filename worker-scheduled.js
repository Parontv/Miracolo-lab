  ...
  async scheduled(event, env, ctx) {
    ctx.waitUntil((async()=>{
      ...
      await Promise.allSettled([
        ...
        fetch(baseUrl+'/api/prices?symbols='+encodeURIComponent('^GSPC,^NDX,^DJI,^RUT,^FTSE,^GDAXI,^FCHI,^STOXX50E,GC=F,AGOLD.MI,SWDA.MI,XMME.MI')+'&cron='+Date.now(),{cache:'no-store'}),
